...
function Tablecell(props) {
  const [tempchecked,settempchecked]=useState(false);
    ...
    return (
        ...
        <Toaster></Toaster>
        <tr>
        <td><div className="check"><input type="checkbox" checked={tempchecked || props.allchecked} onChange={()=>{ settempchecked(!tempchecked);}} className='checkbox' />{tempchecked&&(<svg xmlns="http://www.w3.org/2000/svg" width="20" onClick={props.onCheck()} height="20" viewBox="0 0 20 20" fill="none" style={{cursor:"pointer"}} >
