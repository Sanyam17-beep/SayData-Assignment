            ...
            <div className="navbar"   >
                <div className="Nav-items">
                    ...
                    <div className="Nav-Corner">
                        <div className="NotificationIcon"  ><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" onClick={() =>{ if(!showDropdown)setShowDropdown(true); else setShowDropdown(false);}}>
